...
function Footer(props: Props) {
    ...
    return (
        <div className="relative w-full bg-white">
            ...
            <div className="wrapper">
                <div className="flex flex-wrap max-sm:mx-[5px] sm:mx-[15px] md:mx-[15px] lg:-mx-[15px] xl:-mx-[15px] 2xl:-mx-[15px]">
                    <div className="px-[15px] max-sm:w-full max-sm:py-[76px] sm:w-full sm:py-[76px] md:w-full md:py-[98px] lg:w-[62%] lg:py-[120px] xl:w-[62%] xl:py-[120px] 2xl:w-[62%] 2xl:py-[120px]">
                        <div className="w-full [&>h2]:mb-1.5 [&>h2]:font-regular [&>h2]:tracking-[-1.24px] [&>h2]:last:mb-8 max-sm:[&>h2]:last:-mt-4 sm:[&>h2]:last:-mt-4 md:[&>h2]:last:mt-3.5 lg:[&>h2]:last:mt-3.5 xl:[&>h2]:last:mt-3.5 2xl:[&>h2]:last:mt-3.5">
                            <h2 className="footerheading-2">
                                Got an Idea to Realize?
                            </h2>
                        </div>
                        <div className="w-full">
                            <div className="mb-2.5 flex w-full items-center font-bold text-gray-600 [&>h3]:mb-0 [&>h3]:leading-[48px]">
                                <h3 className="footerheading-3">
                                    This is where logic (code)
                                </h3>
                                <span>
                                    <img
                                        src="/images/icon-astericth.png"
                                        alt="asterict"
                                        width={48}
                                        height={46}
                                    />
                            ...
                            <div className="relative mb-10 flex w-full items-center font-bold text-gray-600 [&>h3]:mb-0 [&>h3]:text-[43px] [&>h3]:leading-[48px]">
                                <h3 className="footerheading-3">
                                    meets emotion (design)
                                </h3>      <div 
        className="tenor-gif-embed" 
        data-postid="23339431" 
        data-share-method="host" 
        data-aspect-ratio="1" 
        data-width="56px"
        style={{ maxWidth: '56px', margin: '0 auto' }} // Opsional: Atur ukuran max GIF
      >
        <a href="https://tenor.com/view/fire-gif-23339431">Fire GIF</a>
        from <a href="https://tenor.com/search/fire-gifs">Fire GIFs</a>
      </div>
      <div className="unhoverfire"></div>

      {/* Skrip untuk menjalankan embed Tenor */}
      <Script 
      ...
      />
                    ...
                    <div className="relative z-3 px-[15px] max-sm:w-full max-sm:py-[76px] sm:w-full sm:py-[76px] md:w-full md:py-[98px] lg:w-[38%] lg:py-[120px] xl:w-[38%] xl:py-[120px] 2xl:py-[120px] 2xl:xl:w-[38%]">
                                    ...
                                    <li>
                                        ...
                                        >
                                            <div className="flex h-[45px] w-[45px] items-center justify-center rounded-[24.5px] border border-[2.5px] border-[#ff0033] bg-white p-2 transition-colors duration-500 ease-in-out hover:bg-[#ff0033] [&>svg]:max-w-full">
                                                ...
                                                >
                                                    <path
                                                        className="cls-1 fill-[#ff0033] transition-colors duration-500 ease-in-out group-hover:!fill-white"
                                                    ...
                                                    />
                                                    <path
                                                        className="cls-2 fill-[#ffffff] transition-colors duration-500 ease-in-out group-hover:!fill-[#ff0033]"
                                        ...
                                        >
                                            <div className="flex h-[45px] w-[45px] items-center justify-center rounded-[24.5px] border border-[2.5px] border-[#0a66c2] bg-white p-2.5 transition-colors duration-500 ease-in-out hover:bg-[#0a66c2] [&>svg]:max-w-full">
                                                ...
                                                >
                                                    ...
                                                    >
                                                        <path
                                                            className="cls-1 fill-[#0a66c2] transition-colors duration-500 ease-in-out group-hover:!fill-white"
                                    ...
                                    <li>
                                        ...
                                        >
                                            <div className="flex h-[45px] w-[45px] items-end justify-center rounded-[24.5px] border border-[2.5px] border-[#24292f] bg-white p-0.5 transition-colors duration-500 ease-in-out hover:bg-[#24292f] [&>svg]:w-[40px]">
                                                ...
                                                >
                                                    <path
                                                        className="cls-1 cls-1 fill-[#24292f] transition-colors duration-500 ease-in-out group-hover:!fill-white"
                                                        d="M38.5,6c-0.2-0.5-0.6-0.9-1.1-1l0,0l0,0l0,0l0,0l0,0c0,0,0,0-0.1,0c-0.1,0-0.1,0-0.2,0c-0.1,0-0.3,0-0.5-0.1
                                                    c-0.4,0-0.9,0-1.5,0.1c-1,0.2-2.3,0.7-4,1.8C31.1,6.8,31,6.9,30.9,7c-0.1,0-0.2-0.1-0.3-0.1c-3-0.7-6.1-0.7-9.1,0
                                                    c-0.1,0-0.2,0.1-0.3,0.1c-0.1-0.1-0.2-0.1-0.3-0.2c-1.6-1.1-3-1.6-4-1.8c-0.6-0.1-1.1-0.2-1.5-0.1c-0.2,0-0.4,0-0.5,0.1
                                                    c-0.1,0-0.1,0-0.2,0c0,0,0,0-0.1,0l0,0l0,0l0,0l0,0l0,0c-0.5,0.2-0.9,0.5-1.1,1c-0.8,1.8-1,3.9-0.6,5.8c0,0.1,0,0.2,0.1,0.3
                                                    c-0.1,0.1-0.2,0.2-0.2,0.3c-1.1,1.8-1.7,3.9-1.7,6c0,4.6,1.4,7.8,3.6,9.8c1.3,1.2,2.8,1.9,4.3,2.3c0.2,0.1,0.3,0.1,0.5,0.1
                                                    c0,0.1,0,0.2-0.1,0.3c-0.1,0.4-0.2,0.8-0.2,1.1c0,0,0,0.1,0,0.1l-0.1,1.4l0,2.1c0,0,0-2,0-2c-0.1,0-0.2,0-0.4,0.1
                                                    c-0.4,0-0.7,0-1.1-0.1c-0.4-0.1-0.7-0.3-1-0.5s-0.5-0.5-0.7-0.8l0,0c-0.5-0.9-1.2-1.6-2-2.1c-0.8-0.6-1.7-0.9-2.7-1.1
                                                    c-1-0.1-2,0.6-2.1,1.6c-0.1,1,0.6,2,1.6,2.1c0.4,0.1,0.8,0.2,1.1,0.4c0.3,0.2,0.6,0.5,0.8,0.9c0.4,0.7,1,1.4,1.6,1.9
                                                    c0.7,0.5,1.5,0.9,2.3,1.2c0.8,0.2,1.7,0.3,2.5,0.2c0,0.5,0,6.7,0,6.9c0.9,0.6,2.5,0.8,2.5,0.8l8.5,0l2.9-0.8v-11
                                                    c0-0.8,0-1.6-0.2-2.4c0-0.1-0.1-0.2-0.1-0.3c0.1,0,0.2-0.1,0.3-0.1c1.5-0.4,3.1-1.1,4.4-2.3c2.3-2,3.6-5.2,3.6-9.8
                                                    c0-2.2-0.6-4.3-1.7-6c-0.1-0.1-0.1-0.2-0.2-0.3c0-0.1,0-0.2,0.1-0.3C39.5,9.9,39.3,7.8,38.5,6z"
                                                    />
                                                </svg>
                                            </div>
                                        </Link>
                            ...
                            <div className="w-full flex 2xl:justify-start xl:justify-start lg:justify-start md:justify-start sm:justify-start max-sm:justify-start">
                                <p>
                                    ...
                                    <span className="font-semibold text-gray-700">
                                        © 2025 Copyright DSGN + CODE Agus Susilo. All rights reserved.
                                    </span>{" "}
                                </p>
                            </div>
                        </div>
