...
export default function Explorations() {
    ...
    return (
        <div ref={wrapperRef} className="relative w-full h-screen">                
            <div
                ref={scrollRef}
                className="sticky flex flex-col top-[40px] xl:pt-[64px] lg:pt-[64px] md:pt-[64px] sm:pt-[56px] max-sm:pt-[56px] flex h-auto min-h-[496px] w-full overflow-hidden 2xl:px-10 xl:px-10 lg:px-10 md:px-[15px] sm:px-[10px] max-sm:px-[10px]"
            >                     
