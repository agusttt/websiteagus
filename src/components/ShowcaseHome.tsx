    ...
    return (
        <div className="h-auto w-full max-sm:py-[76px] sm:py-[76px] md:py-[98px] lg:py-[120px] xl:py-[120px] 2xl:py-[120px]">
            <div className="wrapper">
                <div className="2xl:sticky xl:sticky lg:sticky md:relative sm:relative max-sm:relative 2xl:top-[118px] xl:top-[100px] lg:top-[98px] md:top-[10px] sm:top-[0px] max-sm:top-[0px] flex flex-wrap max-sm:mx-[15px] sm:mx-[15px] md:mx-[15px] lg:-mx-[15px] xl:-mx-[15px] 2xl:-mx-[15px]">
                    <div className="w-full flex px-[15px]">
                        <div className="w-full flex flex-wrap 2xl:[&>h2]:text-[50px] xl:[&>h2]:text-[36px] lg:[&>h2]:text-[34px] md:[&>h2]:text-[32px] sm:[&>h2]:text-[32px] max-sm:[&>h2]:text-[32px] [&>h2]:tracking-[-0.24px] [&>h2]:text-gray-950 [&>h2]:font-bold 2xl:[&>h2]:mb-8 xl:[&>h2]:mb-8 lg:[&>h2]:mb-6 md:[&>h2]:mb-5 sm:[&>h2]:mb-5 max-sm:[&>h2]:mb-5 text-center 2xl:leading-[55px] xl:leading-[41px] lg:leading-[39px] md:leading-[38px] sm:leading-[37px] max-sm:leading-[37px]">
                ...
                <div className="flex flex-col justify-center max-sm:mx-[5px] sm:mx-[15px] md:mx-[15px] lg:-mx-[15px] xl:-mx-[15px]">
                    <div className="2xl:sticky xl:sticky lg:sticky md:relative sm:relative max-sm:relative 2xl:top-[214px] xl:top-[214px] lg:top-[164px] md:top-[164px] sm:top-[0px] max-sm:top-[0px] 2xl:mt-4 xl:mt-3.5 lg:mt-3.5 md:mt-3.5 sm:mt-2 max-sm:mt-2 2xl:mb-4 xl:mb-4 lg:mb-3.5 md:mb-3.5 sm:mb-2 max-sm:mb-2 flex min-h-[286px] w-full flex-wrap items-center overflow-hidden rounded-4xl 2xl:px-[15px] xl:px-[15px] md:px-[0px] sm:px-[15px] max-sm:px-[15px] max-sm:py-3 sm:py-3 md:py-2.5 lg:py-1.5 xl:py-1.5">
                    ...
                    <div className="2xl:sticky xl:sticky lg:sticky md:relative sm:relative max-sm:relative 2xl:top-[230px] xl:top:top-[230px] lg:[top:200px] md:top-[300px] sm:top-[0px] max-sm:top-[0px] 2xl:mt-4 xl:mt-3.5 lg:mt-3.5 md:mt-3.5 sm:mt-2 max-sm:mt-2 2xl:mb-4 xl:mb-4 lg:mb-3.5 md:mb-3.5 sm:mb-2 max-sm:mb-2 flex min-h-[286px] w-full flex-wrap items-center overflow-hidden rounded-4xl 2xl:px-[15px] xl:px-[15px] md:px-[0px] sm:px-[15px] max-sm:px-[15px] max-sm:py-3 sm:py-3 md:py-2.5 lg:py-1.5 xl:py-1.5">
                    ...
                    <div className="2xl:sticky xl:sticky lg:sticky md:relative sm:relative max-sm:relative 2xl:top-[246px] xl:top-[246px] lg:top-[246px] md:top-[220px] sm:top-[0px] max-sm:top-[0px] sm:top-[0px] max-sm:top-[0px] 2xl:mt-4 xl:mt-3.5 lg:mt-3.5 md:mt-3.5 sm:mt-2 max-sm:mt-2 2xl:mb-4 xl:mb-4 lg:mb-3.5 md:mb-3.5 sm:mb-2 max-sm:mb-2 flex min-h-[286px] w-full flex-wrap items-center overflow-hidden rounded-4xl 2xl:px-[15px] xl:px-[15px] md:px-[0px] sm:px-[15px] max-sm:px-[15px] max-sm:py-3 sm:py-3 md:py-2.5 lg:py-1.5 xl:py-1.5">
                        <div className="shadow-[0_1px_10px_#97a4af24] flex w-full flex-wrap items-center rounded-4xl bg-[#eff4ff] max-sm:flex-col max-sm:pt-0 max-sm:pb-8.5 sm:flex-col sm:pt-0 sm:pb-8.5 md:flex-col md:pt-8.5 lg:flex-row lg:pt-9.5 lg:pb-9.5 xl:flex-row xl:pt-9.5 xl:pb-8.5 xl:pb-9.5">
                            <div className="z-3 rounded-tl-4xl rounded-bl-4xl bg-[#eff4ff] max-sm:order-2 max-sm:w-full max-sm:pr-[24px] max-sm:pl-[24px] sm:order-2 sm:w-full sm:pr-[24px] sm:pl-[24px] md:order-1 md:w-[100%] md:pr-[32px] md:pl-[32px] lg:order-1 lg:w-[44%] lg:pr-[30px] lg:pl-[36px] xl:order-1 xl:w-[44%] xl:pr-[30px] 2xl:xl:w-[44%]z-3 rounded-tl-4xl rounded-bl-4xl bg-[#eff4ff] max-sm:order-2 max-sm:w-full max-sm:pr-[24px] max-sm:pl-[24px] sm:order-2 sm:w-full sm:pr-[24px] sm:pl-[24px] md:order-1 md:w-[100%] md:pr-[24px] md:pl-[24px] lg:order-1 md:order-2 lg:w-[44%] lg:pr-[30px] lg:pl-[36px] xl:order-1 xl:w-[44%] xl:pr-[30px] 2xl:xl:w-[44%] md:mt-6.5">
                                <Link
                                    className="text-gray-950 [&>h2]:mb-6 [&>h2]:font-bold [&>h2]:tracking-[-0.92px] [&>h3]:text-[20px] [&>p]:mb-6 [&>p]:text-[20px] [&>p]:leading-[27px] [&>p]:text-gray-500"
